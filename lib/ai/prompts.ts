...
Ответь строго в JSON формате:
{
  ...
  "contractor_message": "Готовый вежливый текст-сообщение подрядчику от лица заказчика. 5-8 предложений. Тон — уважительный но уверенный. Указать конкретные позиции с завышением и предложить рыночные цены. Не обвинять, а предложить пересмотреть. Обязательно похвалить позиции с адекватными ценами если есть."
}
