        ...
        <div className="w-full max-w-md">
          <div className="bg-white rounded-3xl p-8 shadow-2xl shadow-[#161616]/10 border border-[#161616]/5 text-center">
            ...
            <button
              ...
              className="cursor-pointer w-full bg-[#0D8DFF] text-white font-semibold py-4 rounded-full hover:opacity-90 transition-all flex items-center justify-center gap-2"
            >
              Перейти к входу
        ...
        <div className="bg-white rounded-3xl p-8 shadow-2xl shadow-[#161616]/10 border border-[#161616]/5">
          ...
          <form onSubmit={handleRegister} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="cursor-pointer w-full bg-[#33C791] text-white font-semibold py-4 rounded-full hover:opacity-90 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
