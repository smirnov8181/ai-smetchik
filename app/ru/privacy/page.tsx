...
export const metadata = {
  title: "Политика конфиденциальности — AI Сметчик",
};
      ...
      <main className="flex-1 max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="bg-white rounded-2xl border border-[#161616]/5 p-8 space-y-4 text-sm text-[#161616]/70 leading-relaxed">
          <p>
            ...
            защиты персональных данных пользователей сервиса AI Сметчик
            (ContractorCheck).
          </p>
          <p>
            Страница находится в разработке. Полный текст политики
            конфиденциальности будет опубликован в ближайшее время.
          </p>
