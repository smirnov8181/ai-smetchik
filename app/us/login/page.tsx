      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-3xl p-8 shadow-2xl shadow-[#161616]/10 border border-[#161616]/5">
          <div className="text-center mb-8">
            <h1 className="text-2xl font-bold text-[#161616] mb-2">Welcome back</h1>
            <p className="text-[#161616]/50">Sign in to check your estimates</p>
          </div>
          ...
          <p className="text-sm text-center text-[#161616]/50 mt-6">
            ...
            <Link href="/us/register" className="text-[#0D8DFF] font-medium hover:underline">
              Sign up
            </Link>
          </p>
        </div>
